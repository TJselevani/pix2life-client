...
import 'package:pix2life/src/features/audio/presentation/pages/update_audio/update_audio.dart';
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8.h),
                                Text(
                                  "Created At: ${Utility.formatTimestamp('${audio.createdAt}')}  (${Utility.getRelativeTime('${audio.createdAt}')}  Ago) ",
                                  style: TextStyle(fontSize: 14.sp),
                                ),
                                SizedBox(height: 8.h),
                                Text(
                                  'Gallery: ${audio.galleryName}',
                                  style: TextStyle(fontSize: 14.sp),
                                ),
                                SizedBox(height: 8.h),
                                Text(
                          ...
                          Row(
                            ...
                            children: [
                                ...
                                () {
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) => Dialog(
                                      child: UpdateAudioScreen(audio: audio),
                                    ),
                                  );
                                },
                              ),
                              _buildButton(
                                ...
                                'Delete',
                                () {
                                  audioProvider.deleteAudio(audio.id);
                                  Navigator.of(context).pop();
                                },
                              ),
                            ],
